			...
			_createClass(ServerDefinedRechargeWin, [{
				...
				value: function onInit() {
					...
					netmsg.once('rc.querymethod', null, function (pack) {
						...
						self.hide();
						try {
							var Rcwin = __webpack_require__(251)("./" + pack.method.substring(0, pack.method.length - 4) + '.js');
						} catch (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	accWechatIntf('weixin/sign', {}, function (err, conf) {
		...
		var WechatJSSDK = __webpack_require__(87);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./appleStorePay.js": 259,
		"./debugpayment.js": 261,
		"./default.js": 79,
		"./defaultPayment.js": 254,
		"./hepay.js": 82,
		"./inapp.js": 84,
		"./wechat.js": 86
	};
