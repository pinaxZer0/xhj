...
/***/ function(module, exports, __webpack_require__) {
	...
	var ROAD = __webpack_require__(164),
	...
	var HallUI = function () {
		...
		_createClass(HallUI, [{
			...
			value: function renderTables(index, obj) {
				...
				obj.getChild('n94').text = printf('房间%d', tbl.roomid);
				...
				obj.onClick(null, function () {
					_socket.sendp({ c: 'join', code: Number(tbl.roomid) });
				});
				var his = tbl.his;
			...
			value: function create(opt, cb) {
				...
				Laya.loader.load([{ url: __webpack_require__(67), type: Loader.IMAGE }, { url: __webpack_require__(66), type: Loader.IMAGE }, { url: __webpack_require__(68), type: Loader.BUFFER }], Handler.create(null, function () {
					if (!!window.magiclink) {
						magiclink.reg(function (room) {
							console.log('magiclink ret', room);
							_socket.sendp({ c: 'join', code: Number(room) });
						});
					}
					...
					hall.usericon = _view.getChild('n2').getChild('n3').asLoader;
					hall.assignAllBtns();
