	...
	var HallUI = function () {
		...
		_createClass(HallUI, [{
			...
			value: function create(opt, cb) {
				...
				Laya.loader.load([{ url: __webpack_require__(142), type: Loader.IMAGE }, { url: __webpack_require__(152), type: Loader.IMAGE }, { url: __webpack_require__(153), type: Loader.IMAGE }, { url: __webpack_require__(144), type: Loader.BUFFER }], Handler.create(null, function () {
					if (!!window.magiclink) {
