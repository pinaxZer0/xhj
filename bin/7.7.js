	...
	*/
	...
	var Render=(function(){
		function Render(width,height){
			...
			if (!!window.device && device.model.indexOf('iPhone10,3')>=0) style.top="40px";
			else style.top="0px";
			style.left="0px";
	...
	var Stage=(function(_super){
		...
		*/
		...
		__proto._changeCanvasSize=function(){
			this.setScreenSize(Browser.clientWidth *Browser.pixelRatio,(Browser.clientHeight-((!!window.device && device.model.indexOf('iPhone10,3')>=0)?40:0)) *Browser.pixelRatio);
		}
